...
const hero = () => {
  ...
  const handleCountdown = () => {
    const countDate = new Date("April 5, 2024 08:00:00").getTime();
        ...
        <section className="column">
          <div className="left_side">
            ...
            <div className="title1">
              <span className="hackathon"> {"MAKE - A - THON"}</span>
              <br />
            ...
            <div className="register_now">
              ...
              <div>
                {" "}
                <KeyboardDoubleArrowRightSharpIcon style={{ fontSize: 25 }} />
              </div>
            </div>
            <div className="countdown-main">
              <h2 className="countdown-text">
                Join us for an extraordinary Hardware showcase!
              </h2>
          ...
          <div className="right_side">
            ...
            <div className="col1 animated-div">
              ...
              <div className="flex items-start justify-between flex-col">
                <p className="text14">St Joseph's College of Engineering </p>
                <p className="text15">Department of EEE</p>
            ...
            >
              ...
              <div className="flex flex-col ">
                <p className="text-white pt-[2vh] text-[1vw] venue-text-mobile">
                  St. Josephs's Institute of Technology
                </p>{" "}
                <p className="text-white  text-[0.8vw] ">Placement block</p>
