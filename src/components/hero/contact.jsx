                    ...
                    <h2 className="contact-card-description">
                      ...
                      <span
                        ...
                        onClick={() => {
                          ...
                          setTimeout(() => {
                            window.open("mailto:vishnulaxman111103@gmail.com");
                          }, 2000);
                        }}
                      >
                        <EmailRoundedIcon
                        ...
                        />
                        <h6 className="abc"> vishnulaxman111103@gmail.com</h6>
                    ...
                    <h2 className="contact-card-description">
                      <span
                        ...
                        onClick={() => {
                          ...
                          setTimeout(() => {
                            window.open(
                              "https://api.whatsapp.com/send?phone=6369897081"
                            );
                          }, 2000);
                        }}
                      >
                      ...
                      <span
                        ...
                        onClick={() => {
                          ...
                          setTimeout(() => {
                            window.open("mailto: srinivas63698@gmail.com");
                          }, 2000);
                        }}
                      >
                        <EmailRoundedIcon
                        ...
                        />
                        <h6 className="abc">srinivas63698@gmail.com</h6>
